...
calculateWCD <- function(pmids, annotation){
  "
  Calculate weighted co-publication distance between a topic and a gene/protein.
  pmids:        A one-column dataframe containing the total list of PMID accessions in the topic under consideration. A test file is provided in test_pmids.Rds for format requirement.
  annotation:   A tibble of GeneID x PMID relationships, cite counts, and pub year. A  test file containing 100,000 relationships is provided in test_annotation.Rds for format requirement.
